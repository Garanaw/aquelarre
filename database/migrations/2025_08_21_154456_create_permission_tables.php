...
use Database\Seeders\Permission\AssignPermissionsToRolesSeeder;
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->schema->create($tableNames['permissions'], static function (Blueprint $table) {
        ...
        $this->schema->create($tableNames['roles'], static function (Blueprint $table) {
        ...
        $this->schema->create($tableNames['model_has_permissions'], static function (Blueprint $table) use ($tableNames, $columnNames, $pivotPermission) {
        ...
        $this->schema->create($tableNames['model_has_roles'], static function (Blueprint $table) use ($tableNames, $columnNames, $pivotRole) {
        ...
        $this->schema->create($tableNames['role_has_permissions'], static function (Blueprint $table) use ($tableNames, $pivotRole, $pivotPermission) {
            $table->unsignedBigInteger($pivotPermission);
            $table->unsignedBigInteger($pivotRole);
