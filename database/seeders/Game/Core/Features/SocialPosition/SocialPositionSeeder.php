...
namespace Database\Seeders\Game\Core\Features\SocialPosition;

use App\Game\Core\Features\Society\Domain\Reader\Reader;
...
class SocialPositionSeeder extends Seeder
{
    ...
    {
        return $this->db->table('social_positions')->insert($this->getData());
    }

    protected function getData(): array
    {
        $societies = resolve(Reader::class)->all();

        return [
            [
                'name' => 'Alta Nobleza',
                'society_id' => $societies->christian()->id,
                'has_title' => true,
            ...
            [
                'name' => 'Burguesía',
                'society_id' => $societies->judaic()->id,
                'has_title' => false,
            ...
            [
                'name' => 'Alta Nobleza',
                'society_id' => $societies->muslim()->id,
                'has_title' => true,
