...
use App\Game\Core\Features\Spells\Form\Domain\Readers\Reader;
use Database\Seeders\Game\Core\Features\Spell\Helper\Form;
...
class FormSeeder extends Seeder
{
    ...
    {
        $result = $this->db->table(table: 'spell_forms')->insert($this->getData());

        if (!$result) {
            $this->command->error('Error al insertar los datos en la tabla spell_forms');
